...
const Footer = () => {
  return (
    <footer className="fixed bottom-0 left-0 right-0 text-gray-600 body-font bg-gray-700/25 backdrop-blur-lg text-gray-800">
      <div className=" px-4 py-2  mx-auto flex items-center sm:flex-row flex-col">
        <a className="flex title-font font-medium items-center md:justify-start justify-center text-gray-900">
          ...
          <span className="ml-3 text-xl text-blue-400 font-mono"><b>Muhammad Sumair</b> </span>
        </a>
        <p className="text-sm text-gray-200 text-gray-700 sm:ml-4 sm:pl-4 sm:border-l-2 sm:border-gray-200 sm:py-2 sm:mt-0 mt-4">
          ...
          <a
            ...
            target="_blank"
          >
           Developer  Designer & Creator | Muhammad sumair
          </a>
        </p>
